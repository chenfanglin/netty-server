...
import org.netty.network.handle.HttpServerInitializer;
...
public class HttpServerConfig {
    ...
    public ServerBootstrap httpServerBootstrap() {
        ...
        b.group(httpBossGroup(), httpWorkerGroup()).channel(NioServerSocketChannel.class).handler(loggingHandler)
